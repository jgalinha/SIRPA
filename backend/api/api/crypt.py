...
class Crypt():
    ...
    def generate_key_pair(password):
        ...
        try:
            ...
            private_key = key_pair.private_bytes(
                ...
                encryption_algorithm=crypt_serialization.BestAvailableEncryption(Crypt.is_bytes(password))).decode("utf-8")
            ...
            return {"error": "error generating key pair",
                    "msg": f"{e}"}
    ...
    def load_pub_key(public_key):
        ...
        """
        try:
            return crypt_serialization.load_ssh_public_key(Crypt.is_bytes(public_key))
        except ValueError as e:
            return {"error": "The OpenSSH data could not be properly decoded or if the key is not in the proper format",
                    "msg": f"{e}"}
        except UnsupportedAlgorithm as e:
            return {"error": "The serialized key is of a type that is not supported",
                    "msg": f"{e}"}
        except Exception as e:
    ...
    def load_priv_key(private_key, password):
        ...
        try:
            kr = crypt_serialization.load_pem_private_key(
                Crypt.is_bytes(private_key), password=Crypt.is_bytes(password))
            return kr
        except ValueError as e:
            return {"error": "PEM data's structure could not be decoded successfully",
                    "msg": f"{e}"}
        except UnsupportedAlgorithm as e:
            return {"error": "The serialized key type is not supported by the OpenSSL version cryptography is using",
                    "msg": f"{e}"}
        except Exception as e:
            return {"error": "error loadind private key",
                    "msg": f"{e}"}
    ...
    def sign(kr, data):
        ...
        try:
            ...
            return {"error": "The data could not be encrypted",
                    "msg": "{}".format(e)}
        except Exception as e:
            return {"error": "error singing the data",
                    "msg": "{}".format(e)}
    ...
    def verify(ku, data, signature):
        ...
        try:
            ...
            return {"error": "error verifying the data",
                    "msg": "{}".format(e)}
    ...
    def encrypt(key, data):
        ...
        try:
            ...
            return {"error": "error encrypting the data",
                   "msg": "{}".format(e)}
    ...
    def decrypt(key, ciphertext):
        ...
        try:
            ...
            return {"error": "error decrypting the data.",
                    "msg": "{}".format(e)}
    ...
    def is_bytes(data):
        ...
        try:
            ...
            return {"error": "error converting data to bytes",
                    "msg": "{}".format(e)}
